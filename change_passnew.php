...
<body>
    <form action="" method="post">
        <div class="box">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="usere" required>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="exampleInputPassword2" name="newpass2" required>
            </div>
            <div class="subbtn">
    ...
    <!-- <script>
        ...
        document.querySelector('form').addEventListener('submit', function (event) {
            const password1 = document.querySelector('#exampleInputPassword1').value;
            const password2 = document.querySelector('#exampleInputPassword2').value;
