...
<div class="hero-slider" data-carousel>
	<div class="carousel-cell" style="background-image: url(image/1.jpg);">
		...
		<div class="inner">
			...
			<h2 class="title">Enjoy your tour with our best in class buses...</h2>
	...
	<div class="carousel-cell" style="background-image: url(image/2.jpg);">
		...
		<div class="inner">
			...
			<h2 class="title">hassle free online ticket booking...</h2>
			<a href="home.php" class="btn">Go to Home</a>
		</div>
	</div>
	...
	<div class="carousel-cell" style="background-image: url(image/3.jpg);">
		...
		<div class="inner">
			...
			<h2 class="title">Choose bus facilities as per your preference...</h2>
			<a href="home.php" class="btn">Go to Home</a>
		</div>
	</div>
</div>
